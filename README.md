...
Select the channel. To get the optimal intensity, you can play with the min and max bar of the graph.You can also use "Min display" or "Max display". The "Gamma" allows you to amplify low intensity signal.   
